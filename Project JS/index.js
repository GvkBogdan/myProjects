...
fetch('https://jsonplaceholder.typicode.com/users')
    ...
    .then(users => {
        ...
        for (const user of users) {
            ...
            userIdName.innerHTML = `<h4> Id № - ${user.id}_ name - ${user.name}</h4>`
            ...
            userBloc.appendChild(userIdName);
            userBloc.appendChild(userDetailsBtn);
            userBox.appendChild(userBloc);
